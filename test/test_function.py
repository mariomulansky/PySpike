...
def test_pwc():
    ...
    assert_array_equal(
        f([0.0, 0.5, 1.0, 2.0, 2.25, 2.5, 3.5, 4.0]),
    ...
    assert_almost_equal(
        f.avrg(), (1.0 - 0.5 + 0.5 * 1.5 + 1.5 * 0.75) / 4.0, decimal=16
    )
    ...
    assert_almost_equal(
        a, (0.5 * 1.0 - 0.5 * 0.5 + 0.3 * 1.5 + 1.0 * 0.75) / 2.3, decimal=15
    )
...
def test_pwl():
    ...
    a = f.avrg([1.5, 3.5])
    assert_almost_equal(
        a, (-0.425 * 0.5 + 0.75 + (0.75 + 0.75 - 0.5 / 1.5) / 2) / 2.0, decimal=16
    )
    a = f.avrg((1.0, 3.5))
    assert_almost_equal(
        a, (-0.45 + 0.75 + (0.75 + 0.75 - 0.5 / 1.5) / 2) / 2.5, decimal=16
    )
    a = f.avrg([1.0, 4.0])
...
def test_pwl_add():
    ...
    y1_expected = [
        1.5,
        1.0 + 1.0 + 0.5 * 0.75,
        -0.5 + 1.0 - 0.8 * 0.25 / 1.25,
        1.5 - 0.25,
        0.75,
        1.5 + 0.75 - 0.5 * 0.2 / 1.5,
    ]
    y2_expected = [
        0.8 + 1.0 + 0.5 * 0.75,
        1.5 + 1.0 - 0.8 * 0.25 / 1.25,
        -0.4 + 0.2,
        1.5 - 1.0,
        0.75 - 0.5 * 0.2 / 1.5,
        2.25,
