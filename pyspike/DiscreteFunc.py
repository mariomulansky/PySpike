...
class DiscreteFunc:
    ...
    def almost_equal(self, other, decimal=14):
        ...
        return (
            ...
            and np.allclose(self.y, other.y, atol=eps, rtol=0.0)
            and np.allclose(self.mp, other.mp, atol=eps, rtol=0.0)
        )
    ...
    def add(self, f):
        ...
        try:
            from .cython.cython_add import (
                add_discrete_function_cython as add_discrete_function_impl,
            )
        except ImportError:
            ...
            from .cython.python_backend import (
                add_discrete_function_python as add_discrete_function_impl,
            )

        self.x, self.y, self.mp = add_discrete_function_impl(
