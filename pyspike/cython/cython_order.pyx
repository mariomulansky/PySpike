...
############################################################
# spike_order_profiles_cython
############################################################
def spike_order_profiles_cython(double[:] spikes1,
                                         double[:] spikes2,
                                         double t_start, double t_end,
                                         double max_tau,
                                         double MRTS = 0.):
    ...
    cdef int i = -1
    cdef int j = -1
    cdef double[:] d1 = np.zeros(N1)  # order values
    cdef double[:] d2 = np.zeros(N2)  # order values
    cdef double interval = t_end - t_start
    cdef double tau
...
# spike_order_cython
############################################################
def spike_order_cython(double[:] spikes1,
                                double[:] spikes2,
                                double t_start, double t_end,
                                double max_tau,
                                double MRTS = 0.):
