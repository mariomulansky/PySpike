...
latex_documents = [
    ("index", "PySpike.tex", "PySpike Documentation", "Mario Mulansky", "manual"),
]
...
man_pages = [("index", "pyspike", "PySpike Documentation", ["Mario Mulansky"], 1)]
...
texinfo_documents = [
    (
        "index",
        "PySpike",
        "PySpike Documentation",
        "Mario Mulansky",
        "PySpike",
        "Measure of spike train synchrony.",
        "Miscellaneous",
    ),
]
